...
export class OrganizationRequiresAdminApi {
     ...
     */
    public async whitelabelAdminAddUserToProject (organizationId: number, projectId: string, adminAddProjectUserRequest?: AdminAddProjectUserRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async whitelabelAdminGetProject (organizationId: number, projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectInfoResponse> {
     ...
     * @param userId User ID
     */
    public async whitelabelAdminRemoveUserFromProject (organizationId: number, projectId: string, userId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async whitelabelAdminUpdateProject (organizationId: number, projectId: string, updateProjectRequest: UpdateProjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/organizations/{organizationId}/whitelabel/projects/{projectId}'
            .replace('{' + 'organizationId' + '}', encodeURIComponent(String(organizationId)))
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
