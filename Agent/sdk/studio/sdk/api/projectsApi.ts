...
import { ObjectSerializer, Authentication, VoidAuth, Project } from '../model/models';
...
export class ProjectsApi {
     ...
     */
    public async addCollaborator (projectId: string, addCollaboratorRequest: AddCollaboratorRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/collaborators/add'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
            'User-Agent': 'api-nodejs'
        }, this.defaultHeaders);
     ...
     */
    public async addProjectApiKey (projectId: string, addApiKeyRequest: AddApiKeyRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async addProjectHmacKey (projectId: string, addHmacKeyRequest: AddHmacKeyRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async deleteProject (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async deleteVersion (projectId: string, versionId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async getProjectDataAxesSummary (projectId: string, queryParams: getProjectDataAxesSummaryQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectDataAxesSummaryResponse> {
     ...
     * @param projectId Project ID
     */
    public async getProjectInfo (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{"id": string,
    "name": string,
    "sensorName": string,
    "deviceName": string,
    "userEmail": string}> {
        const localVarPath = this.basePath + `/api/project/${projectId}`;
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
            'User-Agent': 'api-nodejs'
        }, this.defaultHeaders);
        ...
        return authenticationPromise.then(() => {
            ...
            "sensorName": string,
            "deviceName": string,
            "userEmail": string}>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @param projectId Project ID
     */
    public async getProjectLastModificationDate (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<LastModificationDateResponse> {
     ...
     * @param projectId Project ID
     */
    public async getProjectRecommendedDataInterval (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectDataIntervalResponse> {
     ...
     * @param includeNotProcessed Whether to include non-processed samples. Defaults to true
     */
    public async getProjectTrainingDataSummary (projectId: string, queryParams: getProjectTrainingDataSummaryQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectTrainingDataSummaryResponse> {
     ...
     * @param projectId Project ID
     */
    public async getSocketToken (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<SocketTokenResponse> {
     ...
     * @param projectId Project ID
     */
    public async launchGettingStartedWizard (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async listDevelopmentBoards (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DevelopmentBoardsResponse> {
     ...
     * @param projectId Project ID
     */
    public async getProjectKey (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<string> {
        const localVarPath = this.basePath + `/api/project/key/${encodeURIComponent(String(projectId))}`;
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
            'User-Agent': 'api-nodejs'
        }, this.defaultHeaders);
        ...
        if (projectId === null || projectId === undefined) {
            throw new Error('Required parameter projectId was null or undefined when calling getProjectKey.');
        }
     ...
     * @param projectId Project ID
     */
    public async listDownloads (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectDownloadsResponse> {
     ...
     * @param projectId Project ID
     */
    public async listEmails (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListEmailResponse> {
     ...
     * @param projectId Project ID
     */
    public async listProjectApiKeys (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListApiKeysResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/apikeys'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     * @param projectId Project ID
     */
    public async listProjectHmacKeys (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListHmacKeysResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/hmackeys'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     */
    public async listProjects (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Project[]> {
     ...
     * @param projectId Project ID
     */
    public async listPublicVersions (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListPublicVersionsResponse> {
     ...
     * @param projectId Project ID
     */
    public async listVersions (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListVersionsResponse> {
     ...
     * @param versionId Version ID
     */
    public async makeVersionPrivate (projectId: string, versionId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async removeCollaborator (projectId: string, removeCollaboratorRequest: RemoveCollaboratorRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async revokeProjectApiKey (projectId: string, apiKeyId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async revokeProjectHmacKey (projectId: string, hmacId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async setProjectComputeTimeLimit (projectId: string, setProjectComputeTimeRequest: SetProjectComputeTimeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async setProjectFileSizeLimit (projectId: string, setProjectDspFileSizeRequest: SetProjectDspFileSizeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param addCollaboratorRequest 
     */
    public async transferOwnership (projectId: string, addCollaboratorRequest: AddCollaboratorRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async transferOwnershipOrganization (projectId: string, transferOwnershipOrganizationRequest: TransferOwnershipOrganizationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async updateProject (projectId: string, updateProjectRequest: UpdateProjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     */
    public async updateProjectTags (projectId: string, updateProjectTagsRequest: UpdateProjectTagsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async updateVersion (projectId: string, versionId: number, updateVersionRequest: UpdateVersionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/versions/{versionId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'versionId' + '}', encodeURIComponent(String(versionId)));
        let localVarQueryParameters: any = {};
     ...
     * @param image 
     */
    public async uploadReadmeImage (projectId: string, params: uploadReadmeImageFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<UploadReadmeImageResponse> {
