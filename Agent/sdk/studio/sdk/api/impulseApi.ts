...
export class ImpulseApi {
     ...
     */
    public async createBlockVersion (projectId: string, blockType: string, blockId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<CreateBlockVersionResponse> {
     ...
     * @param impulse 
     */
    public async createImpulse (projectId: string, impulse: Impulse, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async deleteImpulse (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/impulse'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     * @param projectId Project ID
     */
    public async getImpulse (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetImpulseResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/impulse'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     * @param projectId Project ID
     */
    public async getImpulseAll (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetImpulseResponse> {
     ...
     * @param projectId Project ID
     */
    public async getImpulseBlocks (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetImpulseBlocksResponse> {
     ...
     */
    public async updateBlockVersion (projectId: string, blockType: string, blockId: number, impulseBlockVersion: ImpulseBlockVersion, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/impulse/block-versions/{blockType}/{blockId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'blockType' + '}', encodeURIComponent(String(blockType)))
            .replace('{' + 'blockId' + '}', encodeURIComponent(String(blockId)));
     ...
     */
    public async verifyDspBlockUrl (projectId: string, verifyDspBlockUrlRequest: VerifyDspBlockUrlRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<VerifyDspBlockUrlResponse> {
