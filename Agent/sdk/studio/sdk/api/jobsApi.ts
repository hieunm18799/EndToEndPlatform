...
export class JobsApi {
     ...
     */
    public async autotuneDspJob (projectId: string, autotuneDspRequest: AutotuneDspRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async buildOnDeviceModelJob (projectId: string, buildOnDeviceModelRequest: BuildOnDeviceModelRequest, queryParams: buildOnDeviceModelJobQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async buildOrganizationOnDeviceModelJob (projectId: string, buildOrganizationOnDeviceModelRequest: BuildOrganizationOnDeviceModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async cancelJob (projectId: string, jobId: number, queryParams: cancelJobQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async downloadJobsLogs (projectId: string, jobId: number, queryParams: downloadJobsLogsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<string> {
     ...
     */
    public async exportKerasBlock (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async exportKerasBlockData (projectId: string, learnId: number, exportKerasBlockDataRequest?: ExportKerasBlockDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param projectId Project ID
     */
    public async generateDataExplorerFeatures (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async generateFeaturesJob (projectId: string, generateFeaturesRequest: GenerateFeaturesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param jobId Job ID
     */
    public async getJobStatus (projectId: string, jobId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetJobResponse> {
     ...
     * @param logLevel Log level (error, warn, info, debug)
     */
    public async getJobsLogs (projectId: string, jobId: number, queryParams: getJobsLogsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<LogStdoutResponse> {
     ...
     */
    public async getJobsSummary (projectId: string, queryParams: getJobsSummaryQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<JobSummaryResponse> {
     ...
     * @param jobId Job ID
     */
    public async getProfileTfliteJobResult (projectId: string, jobId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProfileTfLiteResponse> {
     ...
     * @param jobId Job ID
     */
    public async getProfileTfliteJobResultViaPostRequest (projectId: string, jobId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProfileTfLiteResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/jobs/profile-tflite/{jobId}/result'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'jobId' + '}', encodeURIComponent(String(jobId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listActiveJobs (projectId: string, queryParams: listActiveJobsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListJobsResponse> {
     ...
     * @param rootOnly Whether to exclude jobs with a parent ID (so jobs started as part of another job)
     */
    public async listAllJobs (projectId: string, queryParams: listAllJobsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListJobsResponse> {
     ...
     * @param rootOnly Whether to exclude jobs with a parent ID (so jobs started as part of another job)
     */
    public async listFinishedJobs (projectId: string, queryParams: listFinishedJobsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListJobsResponse> {
     ...
     */
    public async optimizeJob (projectId: string, setKerasParameterRequest: SetKerasParameterRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async setTunerPrimaryJob (projectId: string, queryParams: setTunerPrimaryJobQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param projectId Project ID
     */
    public async startClassifyJob (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startDeployPretrainedModelJob (projectId: string, deployPretrainedModelRequest: DeployPretrainedModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param projectId Project ID
     */
    public async startEvaluateJob (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param projectId Project ID
     */
    public async startKeywordsNoiseJob (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startMakeVersionPublicJob (projectId: string, versionId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startOriginalExportJob (projectId: string, exportOriginalDataRequest: ExportOriginalDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startPerformanceCalibrationJob (projectId: string, startPerformanceCalibrationRequest: StartPerformanceCalibrationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startProfileTfliteJob (projectId: string, profileTfLiteRequest: ProfileTfLiteRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startRestoreJob (projectId: string, restoreProjectRequest: RestoreProjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async startRestoreJobFromPublic (projectId: string, restoreProjectFromPublicRequest: RestoreProjectFromPublicRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async startRetrainJob (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startVersionJob (projectId: string, projectVersionRequest: ProjectVersionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async startWavExportJob (projectId: string, exportWavDataRequest: ExportWavDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async trainAnomalyJob (projectId: string, learnId: number, startTrainingRequestAnomaly: StartTrainingRequestAnomaly, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param setKerasParameterRequest 
     */
    public async trainKerasJob (projectId: string, learnId: number, setKerasParameterRequest: SetKerasParameterRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async updateJob (projectId: string, jobId: number, updateJobRequest: UpdateJobRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
