...
export class DeploymentApi {
     ...
     */
    public async findSyntiantPosterior (projectId: string, params: findSyntiantPosteriorFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     * @param engine Optional engine for the build (if not, it uses the default engine for the deployment target)
     */
    public async getDeployment (projectId: string, queryParams: getDeploymentQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetDeploymentResponse> {
     ...
     * @param projectId Project ID
     */
    public async getEvaluateJobResult (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<EvaluateJobResponse> {
     ...
     * @param projectId Project ID
     */
    public async getEvaluateJobResultCache (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<EvaluateJobResponse> {
     ...
     * @param projectId Project ID
     */
    public async getLastDeploymentBuild (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetLastDeploymentBuildResponse> {
     ...
     * @param projectId Project ID
     */
    public async getSyntiantPosterior (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSyntiantPosteriorResponse> {
     ...
     */
    public async setSyntiantPosterior (projectId: string, setSyntiantPosteriorRequest: SetSyntiantPosteriorRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/deployment/syntiant/posterior'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
