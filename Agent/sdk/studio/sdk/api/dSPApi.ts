...
export class DSPApi {
     ...
     */
    public async clearDspBlock (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param dspId DSP Block ID, use the impulse functions to retrieve the ID
     */
    public async getAutotunerResults (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspAutotunerResults> {
     ...
     * @param dspId DSP Block ID, use the impulse functions to retrieve the ID
     */
    public async getDspConfig (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DSPConfigResponse> {
     ...
     * @param dspId DSP Block ID, use the impulse functions to retrieve the ID
     */
    public async getDspFeatureImportance (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspFeatureImportanceResponse> {
     ...
     * @param dspId DSP Block ID, use the impulse functions to retrieve the ID
     */
    public async getDspFeatureLabels (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspFeatureLabelsResponse> {
     ...
     * @param dspId DSP Block ID, use the impulse functions to retrieve the ID
     */
    public async getPerformanceAllVariants (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspPerformanceAllVariantsResponse> {
     ...
     */
    public async runDspOnFeaturesArray (projectId: string, dspId: number, dspRunRequestWithFeatures: DspRunRequestWithFeatures, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspRunResponse> {
     ...
     */
    public async runDspSampleSlice (projectId: string, dspId: number, sampleId: number, dspRunRequestWithoutFeatures: DspRunRequestWithoutFeatures, queryParams: runDspSampleSliceQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspRunResponseWithSample> {
     ...
     */
    public async setDspConfig (projectId: string, dspId: number, dSPConfigRequest: DSPConfigRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/dsp/{dspId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'dspId' + '}', encodeURIComponent(String(dspId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async startProfileCustomDspBlock (projectId: string, dspId: number, dspRunRequestWithoutFeaturesReadOnly: DspRunRequestWithoutFeaturesReadOnly, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
