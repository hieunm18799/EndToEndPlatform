...
export class PerformanceCalibrationApi {
     ...
     */
    public async deletePerformanceCalibrationSavedParameters (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async setPerformanceCalibrationSavedParameters (projectId: string, performanceCalibrationSaveParameterSetRequest: PerformanceCalibrationSaveParameterSetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/performance-calibration/parameters'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     * @param zip 
     */
    public async uploadLabeledAudio (projectId: string, params: uploadLabeledAudioFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<PerformanceCalibrationUploadLabeledAudioResponse> {
