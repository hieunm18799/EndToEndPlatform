...
export class OptimizationApi {
     ...
     */
    public async createTrial (projectId: string, jobId: number, tunerCreateTrialImpulse: TunerCreateTrialImpulse, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async deleteState (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async getConfig (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<OptimizeConfigResponse> {
     ...
     */
    public async getDspParameters (projectId: string, queryParams: getDspParametersQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<OptimizeDSPParametersResponse> {
     ...
     * @param projectId Project ID
     */
    public async getSpace (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<OptimizeSpaceResponse> {
     ...
     * @param projectId Project ID
     */
    public async getState (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<OptimizeStateResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/optimize/state'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     * @param projectId Project ID
     */
    public async getTransferLearningModels (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<OptimizeTransferLearningModelsResponse> {
     ...
     */
    public async getTrialLogs (projectId: string, trialId: string, queryParams: getTrialLogsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<LogStdoutResponse> {
     ...
     * @param projectId Project ID
     */
    public async getWindowSettings (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<WindowSettingsResponse> {
     ...
     * @param tunerCreateTrialImpulse 
     */
    public async scoreTrial (projectId: string, tunerCreateTrialImpulse: TunerCreateTrialImpulse, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ScoreTrialResponse> {
     ...
     */
    public async updateConfig (projectId: string, optimizeConfig: OptimizeConfig, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/optimize/config'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
