...
export class AdminApi {
     ...
     */
    public async adminAddUserToProject (projectId: string, adminAddProjectUserRequest?: AdminAddProjectUserRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async adminAddUserToProjectDeprecated (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async adminDeleteProject (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async adminGetProject (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectInfoResponse> {
        const localVarPath = this.basePath + '/api/admin/projects/{projectId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     * @param userId User ID
     */
    public async adminRemoveUserFromProject (projectId: string, userId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async adminRemoveUserFromProjectDeprecated (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async adminUpdateProject (projectId: string, updateProjectRequest: UpdateProjectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/admin/projects/{projectId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
