...
export class DevicesApi {
     ...
     */
    public async createDevice (projectId: string, createDeviceRequest: CreateDeviceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async deleteDevice (projectId: string, deviceId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param deviceId Device ID
     */
    public async getDevice (projectId: string, deviceId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetDeviceResponse> {
        const localVarPath = this.basePath + `/api/${projectId}/device/${deviceId}`;
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
            'User-Agent': 'api-nodejs'
     ...
     * @param projectId Project ID
     */
    public async listDevices (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListDevicesResponse> {
     ...
     */
    public async renameDevice (projectId: string, deviceId: string, renameDeviceRequest: RenameDeviceRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async startSampling (projectId: string, deviceId: string, startSamplingRequest: StartSamplingRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartSamplingResponse> {
