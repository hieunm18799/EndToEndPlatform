...
export class ThirdPartyAuthApi {
     ...
     */
    public async authorizeThirdParty (projectId: string, authId: number, params: authorizeThirdPartyFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<any> {
