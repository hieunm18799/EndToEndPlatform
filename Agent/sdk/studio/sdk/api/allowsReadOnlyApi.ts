...
export class AllowsReadOnlyApi {
     ...
     */
    public async anomalyTrainedFeatures (projectId: string, learnId: number, queryParams: anomalyTrainedFeaturesQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<AnomalyTrainedFeaturesResponse> {
     ...
     */
    public async anomalyTrainedFeaturesPerSample (projectId: string, learnId: number, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<AnomalyTrainedFeaturesResponse> {
     ...
     */
    public async classifySample (projectId: string, sampleId: number, queryParams: classifySampleQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ClassifySampleResponse> {
     ...
     */
    public async classifySampleByLearnBlock (projectId: string, sampleId: number, blockId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ClassifySampleResponse> {
     ...
     * @summary Download
     * @param projectId Project ID
     * @param type The name of the built target. You can find this by listing all deployment targets through &#x60;listDeploymentTargetsForProject&#x60; (via &#x60;GET /api/{projectId}/deployment/targets&#x60;) and see the &#x60;format&#x60; type.
     ...
     */
    public async downloadBuild (projectId: string, queryParams: downloadBuildQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     */
    public async downloadDspData (projectId: string, dspId: number, category: 'training' | 'testing' | 'anomaly', queryParams: downloadDspDataQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param category Which of the three acquisition categories to download data from
     */
    public async downloadDspLabels (projectId: string, dspId: number, category: 'training' | 'testing' | 'anomaly', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     */
    public async downloadLearnModel (projectId: string, learnId: number, modelDownloadId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param sampleId Sample ID
     */
    public async dspGetFeaturesForSample (projectId: string, dspId: number, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspSampleFeaturesResponse> {
     ...
     * @param category Which of the three acquisition categories to download data from
     */
    public async dspSampleTrainedFeatures (projectId: string, dspId: number, category: 'training' | 'testing' | 'anomaly', queryParams: dspSampleTrainedFeaturesQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspTrainedFeaturesResponse> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getAnomalyMetadata (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<AnomalyModelMetadataResponse> {
     ...
     */
    public async getClassifyJobResult (projectId: string, queryParams: getClassifyJobResultQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ClassifyJobResponse> {
     ...
     */
    public async getClassifyJobResultPage (projectId: string, queryParams: getClassifyJobResultPageQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ClassifyJobResponsePage> {
     ...
     * @param dspId DSP Block ID, use the impulse functions to retrieve the ID
     */
    public async getDspMetadata (projectId: string, dspId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DSPMetadataResponse> {
     ...
     */
    public async getDspRawSample (projectId: string, dspId: number, sampleId: number, queryParams: getDspRawSampleQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSampleResponse> {
     ...
     */
    public async getDspSampleSlice (projectId: string, dspId: number, sampleId: number, queryParams: getDspSampleSliceQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSampleResponse> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getKerasDataExplorerFeatures (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetDataExplorerFeaturesResponse> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getKerasMetadata (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<KerasModelMetadata> {
     ...
     * @param projectId Project ID
     */
    public async getNotes (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetNotesResponse> {
     ...
     * @param projectId Project ID
     */
    public async getPerformanceCalibrationGroundTruth (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetPerformanceCalibrationGroundTruthResponse> {
     ...
     * @param projectId Project ID
     */
    public async getPerformanceCalibrationParameterSets (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetPerformanceCalibrationParameterSetsResponse> {
     ...
     * @param projectId Project ID
     */
    public async getPerformanceCalibrationRawResult (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetPerformanceCalibrationRawResultResponse> {
     ...
     * @param projectId Project ID
     */
    public async getPerformanceCalibrationSavedParameters (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetPerformanceCalibrationParametersResponse> {
     ...
     * @param projectId Project ID
     */
    public async getPerformanceCalibrationStatus (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetPerformanceCalibrationStatusResponse> {
     ...
     * @param projectId Project ID
     */
    public async getProjectInfoSummary (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectInfoSummaryResponse> {
     ...
     * @param projectId Project ID
     */
    public async listDeploymentTargetsForProject (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ProjectDeploymentTargetsResponse> {
     ...
     * @param projectId Project ID
     */
    public async listDeploymentTargetsForProjectDataSources (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DeploymentTargetsResponse> {
     ...
     * @param sliceEnd End index of the slice
     */
    public async runDspSampleSliceReadOnly (projectId: string, dspId: number, sampleId: number, queryParams: runDspSampleSliceReadOnlyQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DspRunResponseWithSample> {
     ...
     */
    public async testPretrainedModel (projectId: string, testPretrainedModelRequest?: TestPretrainedModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<TestPretrainedModelResponse> {
