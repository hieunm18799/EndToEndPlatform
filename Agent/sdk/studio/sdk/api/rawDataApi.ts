...
export class RawDataApi {
     ...
     */
    public async batchDelete (projectId: string, queryParams: batchDeleteQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param excludeIds Exclude samples with an ID within the given list of IDs, given as a JSON string
     */
    public async batchDisable (projectId: string, queryParams: batchDisableQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param excludeIds Exclude samples with an ID within the given list of IDs, given as a JSON string
     */
    public async batchEditLabels (projectId: string, editSampleLabelRequest: EditSampleLabelRequest, queryParams: batchEditLabelsQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param excludeIds Exclude samples with an ID within the given list of IDs, given as a JSON string
     */
    public async batchEnable (projectId: string, queryParams: batchEnableQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param excludeIds Exclude samples with an ID within the given list of IDs, given as a JSON string
     */
    public async batchMove (projectId: string, moveRawDataRequest: MoveRawDataRequest, queryParams: batchMoveQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async classifyUsingAutolabel (projectId: string, sampleId: number, objectDetectionAutoLabelRequest: ObjectDetectionAutoLabelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ObjectDetectionAutoLabelResponse> {
     ...
     * @param projectId Project ID
     */
    public async clearAllObjectDetectionLabels (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async clearDataExplorer (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param includeDisabled Include only enabled or disabled samples (or both)
     */
    public async countSamples (projectId: string, queryParams: countSamplesQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<CountSamplesResponse> {
     ...
     */
    public async cropSample (projectId: string, sampleId: number, cropSampleRequest: CropSampleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<CropSampleResponse> {
     ...
     * @param projectId Project ID
     */
    public async deleteAllSamples (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async deleteAllSamplesByCategory (projectId: string, category: 'training' | 'testing' | 'anomaly', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param sampleId Sample ID
     */
    public async deleteSample (projectId: string, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param sampleId Sample ID
     */
    public async disableSample (projectId: string, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param editSampleLabelRequest 
     */
    public async editLabel (projectId: string, sampleId: number, editSampleLabelRequest: EditSampleLabelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param sampleId Sample ID
     */
    public async enableSample (projectId: string, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async findSegmentsInSample (projectId: string, sampleId: number, findSegmentSampleRequest: FindSegmentSampleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<FindSegmentSampleResponse> {
     ...
     */
    public async getAllImportedFrom (projectId: string, queryParams: getAllImportedFromQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetAllImportedFromResponse> {
     ...
     * @param projectId Project ID
     */
    public async getAutoSegmenter (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetAutoSegmenterResponse> {
     ...
     */
    public async getAutoSegmenterImage (projectId: string, queryParams: getAutoSegmenterImageQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param projectId Project ID
     */
    public async getDataExplorerFeatures (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetDataExplorerFeaturesResponse> {
     ...
     * @param projectId Project ID
     */
    public async getDataExplorerPredictions (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<DataExplorerPredictionsResponse> {
     ...
     * @param projectId Project ID
     */
    public async getDataExplorerSettings (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetDataExplorerSettingsResponse> {
     ...
     * @param projectId Project ID
     */
    public async getObjectDetectionLabelQueue (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ObjectDetectionLabelQueueResponse> {
     ...
     * @param projectId Project ID
     */
    public async getObjectDetectionLabelQueueCount (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ObjectDetectionLabelQueueCountResponse> {
     ...
     */
    public async getSample (projectId: string, sampleId: number, queryParams: getSampleQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSampleResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/raw-data/{sampleId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'sampleId' + '}', encodeURIComponent(String(sampleId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async getSampleAsImage (projectId: string, sampleId: number, queryParams: getSampleAsImageQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param sampleId Sample ID
     */
    public async getSampleAsRaw (projectId: string, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param afterInputBlock Whether to process the image through the input block first
     */
    public async getSampleAsVideo (projectId: string, sampleId: number, queryParams: getSampleAsVideoQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param category Which of the three acquisition categories to retrieve data from
     */
    public async getSampleMetadata (projectId: string, queryParams: getSampleMetadataQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSampleMetadataResponse> {
     ...
     * @param sliceEnd End index of the slice
     */
    public async getSampleSlice (projectId: string, sampleId: number, queryParams: getSampleSliceQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSampleResponse> {
     ...
     */
    public async getUncroppedDownsampledSample (projectId: string, sampleId: number, queryParams: getUncroppedDownsampledSampleQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetSampleResponse> {
     ...
     * @param projectId Project ID
     */
    public async hasDataExplorerFeatures (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<HasDataExplorerFeaturesResponse> {
     ...
     * @param includeDisabled Include only enabled or disabled samples (or both)
     */
    public async listSamples (projectId: string, queryParams: listSamplesQueryParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<ListSamplesResponse> {
     ...
     * @param moveRawDataRequest 
     */
    public async moveSample (projectId: string, sampleId: number, moveRawDataRequest: MoveRawDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param projectId Project ID
     */
    public async rebalanceDataset (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<RebalanceDatasetResponse> {
     ...
     */
    public async renameSample (projectId: string, sampleId: number, renameSampleRequest: RenameSampleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     * @param sampleId Sample ID
     */
    public async retryProcessing (projectId: string, sampleId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async runAutoSegmenter (projectId: string, runAutoSegmenterRequest: RunAutoSegmenterRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async saveAutoSegmenterClusters (projectId: string, saveAutoSegmenterClustersRequest: SaveAutoSegmenterClustersRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<SaveAutoSegmenterClustersResponse> {
     ...
     */
    public async segmentSample (projectId: string, sampleId: number, segmentSampleRequest: SegmentSampleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async setDataExplorerSettings (projectId: string, dataExplorerSettings: DataExplorerSettings, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/raw-data/data-explorer/settings'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({
     ...
     */
    public async setSampleBoundingBoxes (projectId: string, sampleId: number, sampleBoundingBoxesRequest: SampleBoundingBoxesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async setSampleMetadata (projectId: string, sampleId: number, setSampleMetadataRequest: SetSampleMetadataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async splitSampleInFrames (projectId: string, sampleId: number, splitSampleInFramesRequest: SplitSampleInFramesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async storeSegmentLength (projectId: string, storeSegmentLengthRequest: StoreSegmentLengthRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async trackObjects (projectId: string, trackObjectsRequest: TrackObjectsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<TrackObjectsResponse> {
     ...
     * @param image 
     */
    public async uploadDataExplorerScreenshot (projectId: string, params: uploadDataExplorerScreenshotFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
