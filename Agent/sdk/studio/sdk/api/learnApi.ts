...
export class LearnApi {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async downloadKerasData (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async downloadKerasExport (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     */
    public async downloadPretrainedModel (projectId: string, pretrainedModelDownloadType: 'tflite_float32' | 'tflite_int8' | 'onnx' | 'saved_model', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getAnomaly (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<AnomalyResponse> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getKeras (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<KerasResponse> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getLearnXData (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param learnId Learn Block ID, use the impulse functions to retrieve the ID
     */
    public async getLearnYData (projectId: string, learnId: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<Buffer> {
     ...
     * @param projectId Project ID
     */
    public async getPretrainedModelInfo (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GetPretrainedModelResponse> {
     ...
     * @param projectId Project ID
     */
    public async profilePretrainedModel (projectId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
     ...
     */
    public async savePretrainedModelParameters (projectId: string, savePretrainedModelRequest?: SavePretrainedModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async setAnomaly (projectId: string, learnId: number, setAnomalyParameterRequest: SetAnomalyParameterRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/training/anomaly/{learnId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'learnId' + '}', encodeURIComponent(String(learnId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async setKeras (projectId: string, learnId: number, setKerasParameterRequest: SetKerasParameterRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
        const localVarPath = this.basePath + '/api/{projectId}/training/keras/{learnId}'
            .replace('{' + 'projectId' + '}', encodeURIComponent(String(projectId)))
            .replace('{' + 'learnId' + '}', encodeURIComponent(String(learnId)));
        let localVarQueryParameters: any = {};
     ...
     * @param zip 
     */
    public async uploadKerasFiles (projectId: string, learnId: number, params: uploadKerasFilesFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<GenericApiResponse> {
     ...
     */
    public async uploadPretrainedModel (projectId: string, params: uploadPretrainedModelFormParams, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<StartJobResponse> {
