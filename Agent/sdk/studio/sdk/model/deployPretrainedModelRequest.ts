...
export class DeployPretrainedModelRequest {
    ...
    */
    ...
    /**
    * The name of the built target. You can find this by listing all deployment targets through `listDeploymentTargetsForProject` (via `GET /api/{projectId}/deployment/targets`) and see the `format` type.
    */
