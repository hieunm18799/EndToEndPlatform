...
export class EdgeImpulseApi {
    ...
    constructor(opts?: EdgeImpulseApiOpts) {
        ...
        this.admin = new AdminApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.auth = new AuthApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.classify = new ClassifyApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.dsp = new DSPApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.deployment = new DeploymentApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.devices = new DevicesApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.export = new ExportApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.health = new HealthApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.impulse = new ImpulseApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.jobs = new JobsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.learn = new LearnApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.login = new LoginApi(this._opts.endpoint, { extraHeaders: this._opts.extraHeaders });
        this.metrics = new MetricsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.optimization = new OptimizationApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationBlocks = new OrganizationBlocksApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationCreateProject = new OrganizationCreateProjectApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationData = new OrganizationDataApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationDataCampaigns = new OrganizationDataCampaignsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationJobs = new OrganizationJobsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationPipelines = new OrganizationPipelinesApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizationPortals = new OrganizationPortalsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.organizations = new OrganizationsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.performanceCalibration = new PerformanceCalibrationApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.projects = new ProjectsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.rawData = new RawDataApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.themes = new ThemesApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.thirdPartyAuth = new ThirdPartyAuthApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.uploadPortal = new UploadPortalApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.user = new UserApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
        this.whitelabels = new WhitelabelsApi(this._opts.endpoint,
            { extraHeaders: this._opts.extraHeaders });
    ...
    private async getProjectWebsocket(projectId: string) {
